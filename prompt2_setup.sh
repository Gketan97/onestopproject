...
# SIGNAL — Prompt 1 UPDATED (pink-purple gradient + full responsive)
# Place in project root and run:
# chmod +x prompt1_v2.sh && ./prompt1_v2.sh

echo "🚀 Setting up Signal — Prompt 1 v2 (pink-purple + responsive)..."
    ...
    <>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .nav-subtitle, .nav-dot { display: none; }
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hero-eyebrow { padding: 5px 12px 5px 8px; }
          ...
          .hero-orb-tr { width: 300px; height: 300px; }
          .hero-orb-bl { width: 200px; height: 200px; }
        }
...
echo ""
echo "✅ Done! Files updated with pink-purple gradient + full responsiveness"
echo ""
echo "Run: npm run dev"
echo "Check: http://localhost:5173"
echo ""
echo "Test these breakpoints:"
echo "  Desktop  → 1440px, 1280px, 1024px"
echo "  Tablet   → 768px"
echo "  Mobile   → 480px, 375px"