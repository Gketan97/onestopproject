...
export default function Hero() {
  ...
  // Sticky mobile CTA after hero scrolls out
  useEffect(() => {
    ...
    <>
      <style>{`
        ...
        .hero-alert-text {
          ...
          font-size: 11px; letter-spacing: 0.13em; color: #f87171;
        }
        ...
        /* Line 1: "The future of analytics is not" — smaller, muted */
        .hero-line-1 .hero-line-inner {
          font-size: clamp(22px, 3.2vw, 46px);
          color: var(--text-tertiary);
          transition-delay: 0.05s;
        }
        /* Line 2: "Data Pulling & Dashboards." — largest, primary */
        ...
        /* Line 3: "It's decision-making." — gradient, italic */
        ...
        /* Strikethrough animation on line 2 */
        ...
        .hero-cta-btn {
          ...
          padding: 20px 68px; cursor: pointer;
        ...
        .hero-cta-btn:hover {
          ...
          box-shadow: 0 12px 40px rgba(168,85,247,0.38);
        }
        .hero-cta-btn:active { transform: translateY(-1px); }
        .hero-trust {
          font-family: 'DM Mono', monospace;
          font-size: 12px; color: var(--text-tertiary); letter-spacing: 0.06em;
        }
        ...
        .hero-scroll-wheel {
          width: 3px; height: 6px; background: rgba(255,255,255,0.25);
          border-radius: 100px;
      ...
      <section className="hero-section">
        ...
        <div ref={ref} className="hero-content">
          ...
          {/* 3-line headline with per-line slide-up */}
          <HeadlineReveal />
...
// Per-line slide-up reveal — each line animates independently
function HeadlineReveal() {
  const [revealed, setRevealed] = useState(false)

  useEffect(() => {
    // Trigger after mount — slight delay so page paints first
  ...
  return (
    <div className="hero-headline-wrap" style={{ marginBottom: 32 }}>
      ...
      {/* Line 2: largest, with strikethrough animation */}
