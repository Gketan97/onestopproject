...
export const KPI_DATA = {
  ...
  cac: {
    ...
    currentNum: 148,
    prevNum: 142,
    definition: 'What Swiggy spends on average to acquire one new ordering customer — ads, discounts, referrals combined.',
  },
  fleet: {
  ...
  repeat_order_rate: {
    ...
    unit: '%',
    alert: false,
    detail: 'Users ordering 2+ times',
    currentNum: 38.2,
    prevNum: 42.3,
    definition: 'Percentage of users who placed more than one order in the last 30 days.',
  },
  payment_success: {
...
export const ARJUN_KPI_RESPONSES = {
  ...
  repeat_order_rate: {
    immediate: "Repeat rate is down 4 points — but this is a 30-day metric. It reflects behaviour from weeks ago, not what happened Tuesday. You're looking at a lagging signal.",
    followUp: "For a Tuesday incident, you need metrics that move within hours or days. What's your fastest signal?",
    redirectTo: 'conversion',
    conceptTrigger: 'lead_lag',
  },
  payment_success: {
