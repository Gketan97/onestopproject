...
const WhatsAppCalloutCard = () => {
  return (
    <div className="col-span-full glass rounded-lg border border-border p-6 my-3 animate-fade-in-up">
      <div className="flex flex-col sm:flex-row items-start sm:items-center">
        <div className="flex-grow mb-4 sm:mb-0">
          <h3 className="font-bold text-white text-lg">Join Our Developer Community!</h3>
          <p className="text-ink2 text-sm mt-2">Connect with peers, share knowledge, and find your next opportunity on WhatsApp.</p>
        </div>
        <a 
