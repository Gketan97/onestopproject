            ...
            <PageContainer>
                <div className="bg-[#2a2a2a] border border-gray-700 w-full max-w-3xl p-8 rounded-2xl text-center">
                    ...
                    <div className="mt-8 text-center space-y-4">
                        <a href="/#referrals" className="inline-block w-full md:w-auto px-6 py-2 brand-button text-sm font-bold rounded-lg bg-gray-700 hover:bg-gray-600 text-white">
        ...
        <PageContainer>
            <div className="bg-[#2a2a2a] border border-gray-700 w-full max-w-4xl p-6 sm:p-8 rounded-2xl">
                <div className="w-full mb-6">
                    <a href="/#referrals" className="inline-flex items-center gap-2 text-sm text-orange-500 hover:text-orange-400 font-semibold transition-colors">
