...
const StandardMentorCard = ({ mentor }) => (
    ...
    >
        <div className="bg-[#2a2a2a] border border-gray-700 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/10 hover:-translate-y-1 h-full flex flex-col">
            <img 
            ...
            <div className="p-4 text-left flex flex-col flex-grow">
                ...
                <div className="mt-2 text-orange-500 text-xs font-bold self-end transition-all duration-300 group-hover:text-orange-400">
                    View Profile →
                </div>
            </div>
        </div>
...
const FeaturedMentorCard = ({ mentor }) => (
    <a 
        ...
        className="cursor-pointer group w-full block"
    >
        <div className="bg-[#2a2a2a] border border-gray-700 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/20 hover:-translate-y-1 flex flex-col md:flex-row h-full">
            <img 
                src={mentor.avatarUrl} 
                alt={mentor.name} 
            ...
            <div className="p-6 text-left flex flex-col justify-center">
                <span className="bg-orange-500/20 text-orange-400 text-xs font-bold px-3 py-1 rounded-full self-start">
                    Featured Mentor
                </span>
                ...
                <div className="mt-4 text-orange-500 text-sm font-bold transition-all duration-300 group-hover:text-orange-400">
            ...
            <div className="w-full max-w-7xl mx-auto p-4 md:p-8">
                ...
                <div className="text-center mt-12 p-6 bg-gray-800/50 rounded-lg border border-gray-700">
                    ...
                    <p className="text-gray-400 text-sm mt-2">
                        We are in the process of onboarding experts from Software Engineering, Data Science, and other domains.
                    </p>
                </div>
            </div>
        </div>
