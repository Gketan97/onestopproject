    ...
    return (
      <div className="mb-4">
        ...
        <ProduceFirst
          ...
          onSubmit={async () => { onBehaviour('B7', 'Confirmed causation via temporal + geographic evidence for both causes'); setShowNext(true); }}
        />
        {showNext && (
    ...
    return (
      <div className="mb-4">
        ...
        <ProduceFirst
          ...
          onSubmit={async (val) => { onBehaviour('B8', 'Wrote VP message with S/C/R format, two owners, specific timelines'); onDone(val); }}
        />
      </div>
    );
  }
