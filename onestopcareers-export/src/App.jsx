...
// ── Firebase — initialise only when credentials are present ──────────────────
// Missing VITE_FIREBASE_* env vars = build still works, portfolio saves silently
// fall back to localStorage (see portfolioService.js).
...
// Case study routes render their own header inside SwiggyCase
